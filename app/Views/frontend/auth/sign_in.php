        ...
        <section class="section">
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <a href="<?= base_url(); ?>" class="btn btn-primary mt-4 btn-icon"><i class="fas fa-home"></i> Homepage</a>
                    <div class="p-4 m-3">
                        ...
                        <form method="POST" action="<?= base_url('sign-in'); ?>">
                            ...
                            <div class="mt-5 text-center">
                                Don't have an account? <a href="<?= base_url('sign-up'); ?>" class="text-success">Create new one</a>
                            </div>
                        </form>
