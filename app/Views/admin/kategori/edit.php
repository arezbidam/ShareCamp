                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="hidden" name="id_kategori" value="<?= $kategori['id_kategori']; ?>" class="form-control" required readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="keterangan_kategori" class="form-control" style="height: 100px;"><?= $kategori['keterangan_kategori']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
